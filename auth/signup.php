...
<?php 
    ...
    //this checks if the user is already logged in and then takes it back to the homepage
   ...
   if(isset($_POST['submit'])){
        ...
        if(empty($_POST['email']) OR empty($_POST['username']) OR empty($_POST['password']  )) {
            ...
            $insert = $conn->prepare("INSERT INTO users (email, username, password) VALUE (:email, :username, :password)");
