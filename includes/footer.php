        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="footer__logo">
                    <a href="<?php echo APPURL; ?>"><img src="img/logo.png" alt=""></a>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="footer__nav">
                    <ul>
                        <li class="active"><a href="<?php echo APPURL; ?>">Homepage</a></li>
                        <li><a href="<?php echo APPURL; ?>/categories.php">Categories</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3">
